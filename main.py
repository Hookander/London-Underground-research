...
taps = tapsHandler()
print(taps.get_entries_exits('Queensway', '10/01/2019'))
print(taps.get_entries_exits('Queensway', '10/01/2020'))
print(taps.get_entries_exits('Queensway', '10/01/2021'))
print(taps.get_entries_exits('Queensway', '10/01/2022'))